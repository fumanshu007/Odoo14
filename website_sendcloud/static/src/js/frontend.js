odoo.define("website_sendcloud.frontend", function(require) {
    "use strict";

    var core = require("web.core");
    var widget = require("web.public.widget");
    var concurrency = require("web.concurrency");
    var getUserSendcloudLanguage = require("sendcloud_delivery.common").getUserSendcloudLanguage;
    ...
    widget.registry.websiteSaleDelivery.include({
        ...
        xmlDependencies: ['/website_sendcloud/static/src/xml/frontend.xml'],
        ...
        _onServicePointSelected: function($btn, servicePoint) {
            ...
            // Update view
            this.$el.find('#delivery_carrier .o_website_sendcloud_address').remove();
            var address = qweb.render("website_sendcloud.Address", {
