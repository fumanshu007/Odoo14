odoo.define("sendcloud_delivery.ServicePointSelector", function(require) {
    "use strict";
    ...
    var ServicePointSelector = AbstractField.extend({
        ...
        _getHumanReadableValue: function(value, formatted) {
            ...
            if (formatted) {
                return qweb.render("delivery_sendcloud.ServicePointAddress", {
        ...
        _renderEdit: function() {
            ...
            this.$el.html(
                qweb.render(
                    "delivery_sendcloud.ServicePointSelector",
                    renderValues
                )
            );
        },
