...
class SendCloudCreateReturnParcelWizard(models.TransientModel):
    ...
    def _default_language(self):
        lang_code = self.env.lang[0:2].lower()
        lng_map = {
            "en": "en-us",
            "de": "de",
            "es": "es",
    ...
    def _prepare_sendcloud_return_location_from_response(self, records_data):
        return {
            ...
            % (
                records_data.get("id"),
                records_data.get("company_name"),
                records_data.get("country_name"),
            ),
    ...
    def _step2(self, integration):
        ...
        # refund_message = self.refund_message if refund_option_code == "exchange" else ""  # TODO is this correct?
    ...
    def get_sendcloud_details(self):
        # TODO at the moment this method is not yet invoked
        self.ensure_one()
        partner = self.parcel_id.picking_id.partner_id
        return {
            "key": self.sudo().parcel_id.picking_id.carrier_id.sendcloud_integration_id.public_key,
            "country_code": partner.country_id.code or "",
            "postcode": partner.zip or "",
            "carrier_name": [
                self.parcel_id.picking_id.carrier_id.sendcloud_carrier or ""
            ],
        }
